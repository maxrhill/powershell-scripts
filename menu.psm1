...
function Show-Menu {
    Clear-Host
    Write-Host "Welcome to the PowerShell menu!"  -ForegroundColor Green
    Write-Host "Press 1 to scan subnets for windows systems"  -ForegroundColor Green
    Write-Host "2. Option 2" -ForegroundColor Green
    Write-Host "3. Option 3" -ForegroundColor Green
    Write-Host "4. Option 4" -ForegroundColor Green
    Write-Host "5. Option 5" -ForegroundColor Green
...
# Define the main function that runs the menu
...
# Export the Start-Menu function as a module
Export-ModuleMember -Function Invoke-StartMenu
